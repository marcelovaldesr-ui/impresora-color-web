...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Botón circular */}
      <span className="relative w-14 h-14 bg-[#25D366] hover:bg-[#1daa55] rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/50 transition-[background-color,transform] duration-200 active:scale-95">
        ...
        <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-[#F5C51B] rounded-full motion-safe:animate-ping" />
